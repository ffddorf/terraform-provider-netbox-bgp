...
--
-- Name: netbox_bgp_aspathlist; Type: TABLE; Schema: public; Owner: netbox
--

CREATE TABLE public.netbox_bgp_aspathlist (
    id bigint NOT NULL,
    created timestamp with time zone,
    last_updated timestamp with time zone,
    custom_field_data jsonb NOT NULL,
...
ALTER TABLE public.netbox_bgp_aspathlist OWNER TO netbox;

--
-- Name: netbox_bgp_aspathlist_id_seq; Type: SEQUENCE; Schema: public; Owner: netbox
--

ALTER TABLE public.netbox_bgp_aspathlist ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.netbox_bgp_aspathlist_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: netbox_bgp_aspathlistrule; Type: TABLE; Schema: public; Owner: netbox
--

CREATE TABLE public.netbox_bgp_aspathlistrule (
    id bigint NOT NULL,
    created timestamp with time zone,
    last_updated timestamp with time zone,
    custom_field_data jsonb NOT NULL,
    ...
    description character varying(200) NOT NULL,
    comments text NOT NULL,
    aspath_list_id bigint NOT NULL,
    CONSTRAINT netbox_bgp_aspathlistrule_index_check CHECK ((index >= 0))
);


ALTER TABLE public.netbox_bgp_aspathlistrule OWNER TO netbox;

--
-- Name: netbox_bgp_aspathlistrule_id_seq; Type: SEQUENCE; Schema: public; Owner: netbox
--

ALTER TABLE public.netbox_bgp_aspathlistrule ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.netbox_bgp_aspathlistrule_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list; Type: TABLE; Schema: public; Owner: netbox
--

CREATE TABLE public.netbox_bgp_routingpolicyrule_match_aspath_list (
    id bigint NOT NULL,
    routingpolicyrule_id bigint NOT NULL,
    aspathlist_id bigint NOT NULL
);


ALTER TABLE public.netbox_bgp_routingpolicyrule_match_aspath_list OWNER TO netbox;

--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list_id_seq; Type: SEQUENCE; Schema: public; Owner: netbox
--

ALTER TABLE public.netbox_bgp_routingpolicyrule_match_aspath_list ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.netbox_bgp_routingpolicyrule_match_aspath_list_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
594	Can add community	155	add_community
595	Can change community	155	change_community
596	Can delete community	155	delete_community
597	Can view community	155	view_community
598	Can add bgp session	160	add_bgpsession
599	Can change bgp session	160	change_bgpsession
600	Can delete bgp session	160	delete_bgpsession
601	Can view bgp session	160	view_bgpsession
602	Can add bgp peer group	154	add_bgppeergroup
603	Can change bgp peer group	154	change_bgppeergroup
604	Can delete bgp peer group	154	delete_bgppeergroup
605	Can view bgp peer group	154	view_bgppeergroup
606	Can add routing policy	153	add_routingpolicy
607	Can change routing policy	153	change_routingpolicy
608	Can delete routing policy	153	delete_routingpolicy
609	Can view routing policy	153	view_routingpolicy
610	Can add routing policy rule	161	add_routingpolicyrule
611	Can change routing policy rule	161	change_routingpolicyrule
612	Can delete routing policy rule	161	delete_routingpolicyrule
613	Can view routing policy rule	161	view_routingpolicyrule
614	Can add prefix list	158	add_prefixlist
615	Can change prefix list	158	change_prefixlist
616	Can delete prefix list	158	delete_prefixlist
617	Can view prefix list	158	view_prefixlist
618	Can add prefix list rule	159	add_prefixlistrule
619	Can change prefix list rule	159	change_prefixlistrule
620	Can delete prefix list rule	159	delete_prefixlistrule
621	Can view prefix list rule	159	view_prefixlistrule
622	Can add community list	156	add_communitylist
623	Can change community list	156	change_communitylist
624	Can delete community list	156	delete_communitylist
625	Can view community list	156	view_communitylist
626	Can add community list rule	157	add_communitylistrule
627	Can change community list rule	157	change_communitylistrule
628	Can delete community list rule	157	delete_communitylistrule
629	Can view community list rule	157	view_communitylistrule
630	Can add as path list	151	add_aspathlist
631	Can change as path list	151	change_aspathlist
632	Can delete as path list	151	delete_aspathlist
633	Can view as path list	151	view_aspathlist
634	Can add as path list rule	152	add_aspathlistrule
635	Can change as path list rule	152	change_aspathlistrule
636	Can delete as path list rule	152	delete_aspathlistrule
637	Can view as path list rule	152	view_aspathlistrule
\.
...
157	t	{bookmarks,change_logging,cloning,custom_fields,custom_links,custom_validation,event_rules,export_templates,journaling,notifications,tags}
...
159	t	{bookmarks,change_logging,cloning,custom_fields,custom_links,custom_validation,event_rules,export_templates,journaling,notifications,tags}
160	t	{bookmarks,change_logging,cloning,custom_fields,custom_links,custom_validation,event_rules,export_templates,journaling,notifications,tags}
161	t	{bookmarks,change_logging,cloning,custom_fields,custom_links,custom_validation,event_rules,export_templates,journaling,notifications,tags}
\.
...
1	2025-11-18 18:22:49.204946+00	2025-11-18 18:22:49.204953+00	{}			CPU	{"properties": {"cores": {"type": "integer", "description": "Number of cores present"}, "speed": {"type": "number", "title": "Speed", "description": "Clock speed in GHz"}, "architecture": {"type": "string", "title": "Architecture"}}}
2	2025-11-18 18:22:49.210271+00	2025-11-18 18:22:49.210274+00	{}			Fan	{"properties": {"rpm": {"type": "integer", "title": "RPM", "description": "Fan speed (RPM)"}}}
3	2025-11-18 18:22:49.212343+00	2025-11-18 18:22:49.212346+00	{}			GPU	{"required": ["memory"], "properties": {"gpu": {"type": "string", "title": "GPU"}, "memory": {"type": "integer", "title": "Memory (GB)", "description": "Total memory capacity (in GB)"}, "interface": {"enum": ["PCIe 4.0", "PCIe 4.0 x8", "PCIe 4.0 x16", "PCIe 5.0 x16"], "type": "string"}}}
4	2025-11-18 18:22:49.214279+00	2025-11-18 18:22:49.214281+00	{}			Hard disk	{"required": ["size"], "properties": {"size": {"type": "integer", "title": "Size (GB)", "description": "Raw disk capacity"}, "type": {"enum": ["HD", "SSD", "NVME"], "type": "string", "title": "Disk type", "default": "SSD"}, "speed": {"type": "integer", "title": "Speed (RPM)"}}}
5	2025-11-18 18:22:49.216153+00	2025-11-18 18:22:49.216155+00	{}			Memory	{"required": ["class", "size"], "properties": {"ecc": {"type": "boolean", "title": "ECC", "description": "Error-correcting code is enabled"}, "size": {"type": "integer", "title": "Size (GB)", "description": "Raw capacity of the module"}, "class": {"enum": ["DDR3", "DDR4", "DDR5"], "type": "string", "title": "Memory class", "default": "DDR5"}, "data_rate": {"type": "integer", "title": "Data rate", "description": "Speed in MT/s"}}}
6	2025-11-18 18:22:49.218055+00	2025-11-18 18:22:49.218058+00	{}			Power supply	{"required": ["input_current", "input_voltage"], "properties": {"wattage": {"type": "integer", "description": "Available output power (watts)"}, "hot_swappable": {"type": "boolean", "title": "Hot-swappable", "default": false}, "input_current": {"enum": ["AC", "DC"], "type": "string", "title": "Current type", "default": "AC"}, "input_voltage": {"type": "integer", "title": "Voltage", "default": 120}}}
7	2025-11-18 18:22:49.219903+00	2025-11-18 18:22:49.219905+00	{}			Expansion card	{"properties": {"bandwidth": {"type": "integer", "description": "Total Bandwidth for this module"}, "connector_type": {"type": "string", "description": "Connector type e.g. PCIe x4"}}}
\.
...
150	django_rq	queue
151	netbox_bgp	aspathlist
152	netbox_bgp	aspathlistrule
153	netbox_bgp	routingpolicy
154	netbox_bgp	bgppeergroup
155	netbox_bgp	community
156	netbox_bgp	communitylist
157	netbox_bgp	communitylistrule
158	netbox_bgp	prefixlist
159	netbox_bgp	prefixlistrule
160	netbox_bgp	bgpsession
161	netbox_bgp	routingpolicyrule
\.
...
1	contenttypes	0001_initial	2025-11-18 18:22:06.700158+00
2	contenttypes	0002_remove_content_type_name	2025-11-18 18:22:06.703409+00
3	auth	0001_initial	2025-11-18 18:22:06.718058+00
4	auth	0002_alter_permission_name_max_length	2025-11-18 18:22:06.720047+00
5	auth	0003_alter_user_email_max_length	2025-11-18 18:22:06.72166+00
6	auth	0004_alter_user_username_opts	2025-11-18 18:22:06.723293+00
7	auth	0005_alter_user_last_login_null	2025-11-18 18:22:06.724826+00
8	auth	0006_require_contenttypes_0002	2025-11-18 18:22:06.725311+00
9	auth	0007_alter_validators_add_error_messages	2025-11-18 18:22:06.726685+00
10	auth	0008_alter_user_username_max_length	2025-11-18 18:22:06.72802+00
11	auth	0009_alter_user_last_name_max_length	2025-11-18 18:22:06.72946+00
12	auth	0010_alter_group_name_max_length	2025-11-18 18:22:06.73151+00
13	auth	0011_update_proxy_permissions	2025-11-18 18:22:06.732791+00
14	auth	0012_alter_user_first_name_max_length	2025-11-18 18:22:06.734106+00
15	users	0001_api_tokens	2025-11-18 18:22:06.775822+00
16	users	0002_unicode_literals	2025-11-18 18:22:06.776313+00
17	users	0003_token_permissions	2025-11-18 18:22:06.776542+00
18	users	0004_standardize_description	2025-11-18 18:22:06.776822+00
19	users	0005_userconfig	2025-11-18 18:22:06.777209+00
20	users	0006_create_userconfigs	2025-11-18 18:22:06.777532+00
21	users	0007_proxy_group_user	2025-11-18 18:22:06.777863+00
22	users	0008_objectpermission	2025-11-18 18:22:06.778416+00
23	users	0009_replicate_permissions	2025-11-18 18:22:06.778846+00
24	users	0010_update_jsonfield	2025-11-18 18:22:06.779311+00
25	users	0011_standardize_models	2025-11-18 18:22:06.779605+00
26	users	0002_standardize_id_fields	2025-11-18 18:22:06.803446+00
27	users	0003_token_allowed_ips_last_used	2025-11-18 18:22:06.803793+00
28	users	0004_netboxgroup_netboxuser	2025-11-18 18:22:06.803954+00
29	account	0001_initial	2025-11-18 18:22:06.804933+00
30	extras	0001_initial	2025-11-18 18:22:06.912567+00
31	tenancy	0001_initial	2025-11-18 18:22:06.935446+00
32	tenancy	0002_tenant_group_optional	2025-11-18 18:22:06.935915+00
33	tenancy	0003_unicode_literals	2025-11-18 18:22:06.936152+00
34	tenancy	0004_tags	2025-11-18 18:22:06.936362+00
35	tenancy	0005_change_logging	2025-11-18 18:22:06.936552+00
36	tenancy	0006_custom_tag_models	2025-11-18 18:22:06.936825+00
37	tenancy	0007_nested_tenantgroups	2025-11-18 18:22:06.93725+00
38	tenancy	0008_nested_tenantgroups_rebuild	2025-11-18 18:22:06.937495+00
39	tenancy	0009_standardize_description	2025-11-18 18:22:06.937716+00
40	tenancy	0010_custom_field_data	2025-11-18 18:22:06.937944+00
41	tenancy	0011_standardize_name_length	2025-11-18 18:22:06.938154+00
42	tenancy	0012_standardize_models	2025-11-18 18:22:06.938365+00
43	dcim	0001_initial	2025-11-18 18:22:07.063016+00
44	dcim	0002_auto_20160622_1821	2025-11-18 18:22:07.974054+00
45	ipam	0001_initial	2025-11-18 18:22:08.111371+00
46	virtualization	0001_virtualization	2025-11-18 18:22:08.288593+00
47	virtualization	0002_virtualmachine_add_status	2025-11-18 18:22:08.289082+00
48	virtualization	0003_cluster_add_site	2025-11-18 18:22:08.289323+00
49	virtualization	0004_virtualmachine_add_role	2025-11-18 18:22:08.289513+00
50	virtualization	0005_django2	2025-11-18 18:22:08.289695+00
51	virtualization	0006_tags	2025-11-18 18:22:08.289872+00
52	virtualization	0007_change_logging	2025-11-18 18:22:08.290048+00
53	virtualization	0008_virtualmachine_local_context_data	2025-11-18 18:22:08.290254+00
54	virtualization	0009_custom_tag_models	2025-11-18 18:22:08.290471+00
55	virtualization	0010_cluster_add_tenant	2025-11-18 18:22:08.29066+00
56	virtualization	0011_3569_virtualmachine_fields	2025-11-18 18:22:08.290842+00
57	virtualization	0012_vm_name_nonunique	2025-11-18 18:22:08.291019+00
58	virtualization	0013_deterministic_ordering	2025-11-18 18:22:08.29121+00
59	virtualization	0014_standardize_description	2025-11-18 18:22:08.291393+00
60	virtualization	0015_vminterface	2025-11-18 18:22:08.291594+00
61	virtualization	0016_replicate_interfaces	2025-11-18 18:22:08.291781+00
62	virtualization	0017_update_jsonfield	2025-11-18 18:22:08.291959+00
63	virtualization	0018_custom_field_data	2025-11-18 18:22:08.292155+00
64	virtualization	0019_standardize_name_length	2025-11-18 18:22:08.292349+00
65	virtualization	0020_standardize_models	2025-11-18 18:22:08.292546+00
66	virtualization	0021_virtualmachine_vcpus_decimal	2025-11-18 18:22:08.292721+00
67	virtualization	0022_vminterface_parent	2025-11-18 18:22:08.292945+00
68	extras	0002_custom_fields	2025-11-18 18:22:08.705683+00
69	extras	0003_exporttemplate_add_description	2025-11-18 18:22:08.706208+00
70	extras	0004_topologymap_change_comma_to_semicolon	2025-11-18 18:22:08.706418+00
71	extras	0005_useraction_add_bulk_create	2025-11-18 18:22:08.706609+00
72	extras	0006_add_imageattachments	2025-11-18 18:22:08.706792+00
73	extras	0007_unicode_literals	2025-11-18 18:22:08.706986+00
74	extras	0008_reports	2025-11-18 18:22:08.707165+00
75	extras	0009_topologymap_type	2025-11-18 18:22:08.707407+00
76	extras	0010_customfield_filter_logic	2025-11-18 18:22:08.707607+00
77	extras	0011_django2	2025-11-18 18:22:08.707789+00
78	extras	0012_webhooks	2025-11-18 18:22:08.708015+00
79	extras	0013_objectchange	2025-11-18 18:22:08.708254+00
80	extras	0014_configcontexts	2025-11-18 18:22:08.708468+00
81	extras	0015_remove_useraction	2025-11-18 18:22:08.708672+00
82	extras	0016_exporttemplate_add_cable	2025-11-18 18:22:08.70888+00
83	extras	0017_exporttemplate_mime_type_length	2025-11-18 18:22:08.709089+00
84	extras	0018_exporttemplate_add_jinja2	2025-11-18 18:22:08.709266+00
85	extras	0019_tag_taggeditem	2025-11-18 18:22:08.709457+00
86	extras	0020_tag_data	2025-11-18 18:22:08.709657+00
87	extras	0021_add_color_comments_changelog_to_tag	2025-11-18 18:22:08.709867+00
88	extras	0022_custom_links	2025-11-18 18:22:08.710062+00
89	extras	0023_fix_tag_sequences	2025-11-18 18:22:08.710233+00
90	extras	0024_scripts	2025-11-18 18:22:08.710402+00
91	extras	0025_objectchange_time_index	2025-11-18 18:22:08.710573+00
92	extras	0026_webhook_ca_file_path	2025-11-18 18:22:08.710748+00
93	extras	0027_webhook_additional_headers	2025-11-18 18:22:08.710929+00
94	extras	0028_remove_topology_maps	2025-11-18 18:22:08.711103+00
95	extras	0029_3569_customfield_fields	2025-11-18 18:22:08.711287+00
96	extras	0030_3569_objectchange_fields	2025-11-18 18:22:08.71148+00
97	extras	0031_3569_exporttemplate_fields	2025-11-18 18:22:08.711668+00
98	extras	0032_3569_webhook_fields	2025-11-18 18:22:08.711858+00
99	extras	0033_graph_type_template_language	2025-11-18 18:22:08.712091+00
100	extras	0034_configcontext_tags	2025-11-18 18:22:08.712309+00
101	extras	0035_deterministic_ordering	2025-11-18 18:22:08.712505+00
102	extras	0036_contenttype_filters_to_q_objects	2025-11-18 18:22:08.712792+00
103	extras	0037_configcontexts_clusters	2025-11-18 18:22:08.713058+00
104	extras	0038_webhook_template_support	2025-11-18 18:22:08.713276+00
105	extras	0039_update_features_content_types	2025-11-18 18:22:08.713611+00
106	extras	0040_standardize_description	2025-11-18 18:22:08.713793+00
107	extras	0041_tag_description	2025-11-18 18:22:08.714029+00
108	extras	0042_customfield_manager	2025-11-18 18:22:08.714262+00
109	extras	0043_report	2025-11-18 18:22:08.714456+00
110	extras	0044_jobresult	2025-11-18 18:22:08.714636+00
111	extras	0045_configcontext_changelog	2025-11-18 18:22:08.71481+00
112	extras	0046_update_jsonfield	2025-11-18 18:22:08.715008+00
113	extras	0047_tag_ordering	2025-11-18 18:22:08.715225+00
114	extras	0048_exporttemplate_remove_template_language	2025-11-18 18:22:08.715421+00
115	extras	0049_remove_graph	2025-11-18 18:22:08.715621+00
116	extras	0050_customfield_changes	2025-11-18 18:22:08.715813+00
117	extras	0051_migrate_customfields	2025-11-18 18:22:08.716003+00
118	extras	0052_customfield_cleanup	2025-11-18 18:22:08.716197+00
119	extras	0053_rename_webhook_obj_type	2025-11-18 18:22:08.716387+00
120	extras	0054_standardize_models	2025-11-18 18:22:08.716582+00
121	extras	0055_objectchange_data	2025-11-18 18:22:08.716769+00
122	extras	0056_extend_configcontext	2025-11-18 18:22:08.716955+00
123	extras	0057_customlink_rename_fields	2025-11-18 18:22:08.717157+00
124	extras	0058_journalentry	2025-11-18 18:22:08.717391+00
125	extras	0059_exporttemplate_as_attachment	2025-11-18 18:22:08.717639+00
126	tenancy	0002_tenant_ordering	2025-11-18 18:22:09.247747+00
127	tenancy	0003_contacts	2025-11-18 18:22:09.248209+00
128	tenancy	0004_extend_tag_support	2025-11-18 18:22:09.248478+00
129	tenancy	0005_standardize_id_fields	2025-11-18 18:22:09.248702+00
130	tenancy	0006_created_datetimefield	2025-11-18 18:22:09.248929+00
131	tenancy	0007_contact_link	2025-11-18 18:22:09.249183+00
132	tenancy	0008_unique_constraints	2025-11-18 18:22:09.249407+00
133	tenancy	0009_standardize_description_comments	2025-11-18 18:22:09.249626+00
134	tenancy	0010_tenant_relax_uniqueness	2025-11-18 18:22:09.249841+00
135	tenancy	0011_contactassignment_tags	2025-11-18 18:22:09.250043+00
136	dcim	0003_auto_20160628_1721	2025-11-18 18:22:11.122693+00
137	dcim	0004_auto_20160701_2049	2025-11-18 18:22:11.12317+00
138	dcim	0005_auto_20160706_1722	2025-11-18 18:22:11.123393+00
139	dcim	0006_add_device_primary_ip4_ip6	2025-11-18 18:22:11.123594+00
140	dcim	0007_device_copy_primary_ip	2025-11-18 18:22:11.123808+00
141	dcim	0008_device_remove_primary_ip	2025-11-18 18:22:11.124028+00
142	dcim	0009_site_32bit_asn_support	2025-11-18 18:22:11.12421+00
143	dcim	0010_devicebay_installed_device_set_null	2025-11-18 18:22:11.124382+00
144	dcim	0011_devicetype_part_number	2025-11-18 18:22:11.124637+00
145	dcim	0012_site_rack_device_add_tenant	2025-11-18 18:22:11.124893+00
146	dcim	0013_add_interface_form_factors	2025-11-18 18:22:11.125094+00
147	dcim	0014_rack_add_type_width	2025-11-18 18:22:11.125282+00
148	dcim	0015_rack_add_u_height_validator	2025-11-18 18:22:11.125607+00
149	dcim	0016_module_add_manufacturer	2025-11-18 18:22:11.125829+00
150	dcim	0017_rack_add_role	2025-11-18 18:22:11.126022+00
151	dcim	0018_device_add_asset_tag	2025-11-18 18:22:11.126209+00
152	dcim	0019_new_iface_form_factors	2025-11-18 18:22:11.126384+00
153	dcim	0020_rack_desc_units	2025-11-18 18:22:11.126571+00
154	dcim	0021_add_ff_flexstack	2025-11-18 18:22:11.126767+00
155	dcim	0022_color_names_to_rgb	2025-11-18 18:22:11.126945+00
156	dcim	0023_devicetype_comments	2025-11-18 18:22:11.12712+00
157	dcim	0024_site_add_contact_fields	2025-11-18 18:22:11.127323+00
158	dcim	0025_devicetype_add_interface_ordering	2025-11-18 18:22:11.127493+00
159	dcim	0026_add_rack_reservations	2025-11-18 18:22:11.127668+00
160	dcim	0027_device_add_site	2025-11-18 18:22:11.127853+00
161	dcim	0028_device_copy_rack_to_site	2025-11-18 18:22:11.128061+00
162	dcim	0029_allow_rackless_devices	2025-11-18 18:22:11.128253+00
163	dcim	0030_interface_add_lag	2025-11-18 18:22:11.128449+00
164	dcim	0031_regions	2025-11-18 18:22:11.128623+00
165	dcim	0032_device_increase_name_length	2025-11-18 18:22:11.128804+00
166	dcim	0033_rackreservation_rack_editable	2025-11-18 18:22:11.128988+00
167	dcim	0034_rename_module_to_inventoryitem	2025-11-18 18:22:11.12916+00
168	dcim	0035_device_expand_status_choices	2025-11-18 18:22:11.129342+00
169	dcim	0036_add_ff_juniper_vcp	2025-11-18 18:22:11.129543+00
170	dcim	0037_unicode_literals	2025-11-18 18:22:11.129722+00
171	dcim	0038_wireless_interfaces	2025-11-18 18:22:11.129895+00
172	dcim	0039_interface_add_enabled_mtu	2025-11-18 18:22:11.130067+00
173	dcim	0040_inventoryitem_add_asset_tag_description	2025-11-18 18:22:11.130237+00
174	dcim	0041_napalm_integration	2025-11-18 18:22:11.130424+00
175	dcim	0042_interface_ff_10ge_cx4	2025-11-18 18:22:11.130608+00
176	dcim	0043_device_component_name_lengths	2025-11-18 18:22:11.130816+00
177	dcim	0044_virtualization	2025-11-18 18:22:11.131002+00
178	dcim	0045_devicerole_vm_role	2025-11-18 18:22:11.131175+00
179	dcim	0046_rack_lengthen_facility_id	2025-11-18 18:22:11.131593+00
180	dcim	0047_more_100ge_form_factors	2025-11-18 18:22:11.131777+00
181	dcim	0048_rack_serial	2025-11-18 18:22:11.131952+00
182	dcim	0049_rackreservation_change_user	2025-11-18 18:22:11.132125+00
183	dcim	0050_interface_vlan_tagging	2025-11-18 18:22:11.132294+00
184	dcim	0051_rackreservation_tenant	2025-11-18 18:22:11.132473+00
185	dcim	0052_virtual_chassis	2025-11-18 18:22:11.132675+00
186	dcim	0053_platform_manufacturer	2025-11-18 18:22:11.132868+00
187	dcim	0054_site_status_timezone_description	2025-11-18 18:22:11.133037+00
188	dcim	0055_virtualchassis_ordering	2025-11-18 18:22:11.133202+00
189	dcim	0056_django2	2025-11-18 18:22:11.133376+00
190	dcim	0057_tags	2025-11-18 18:22:11.13356+00
191	dcim	0058_relax_rack_naming_constraints	2025-11-18 18:22:11.133742+00
192	dcim	0059_site_latitude_longitude	2025-11-18 18:22:11.133912+00
193	dcim	0060_change_logging	2025-11-18 18:22:11.13408+00
194	dcim	0061_platform_napalm_args	2025-11-18 18:22:11.134253+00
195	dcim	0062_interface_mtu	2025-11-18 18:22:11.134604+00
196	dcim	0063_device_local_context_data	2025-11-18 18:22:11.134859+00
197	dcim	0064_remove_platform_rpc_client	2025-11-18 18:22:11.135079+00
198	dcim	0065_front_rear_ports	2025-11-18 18:22:11.13526+00
199	dcim	0066_cables	2025-11-18 18:22:11.135522+00
200	dcim	0067_device_type_remove_qualifiers	2025-11-18 18:22:11.135778+00
201	dcim	0068_rack_new_fields	2025-11-18 18:22:11.135976+00
202	dcim	0069_deprecate_nullablecharfield	2025-11-18 18:22:11.13617+00
203	dcim	0070_custom_tag_models	2025-11-18 18:22:11.136397+00
204	dcim	0071_device_components_add_description	2025-11-18 18:22:11.136609+00
205	dcim	0072_powerfeeds	2025-11-18 18:22:11.136797+00
206	dcim	0073_interface_form_factor_to_type	2025-11-18 18:22:11.136978+00
207	dcim	0074_increase_field_length_platform_name_slug	2025-11-18 18:22:11.137145+00
208	dcim	0075_cable_devices	2025-11-18 18:22:11.137311+00
209	dcim	0076_console_port_types	2025-11-18 18:22:11.137485+00
210	dcim	0077_power_types	2025-11-18 18:22:11.137645+00
211	dcim	0078_3569_site_fields	2025-11-18 18:22:11.137808+00
212	dcim	0079_3569_rack_fields	2025-11-18 18:22:11.137975+00
213	dcim	0080_3569_devicetype_fields	2025-11-18 18:22:11.138134+00
214	dcim	0081_3569_device_fields	2025-11-18 18:22:11.138294+00
215	dcim	0082_3569_interface_fields	2025-11-18 18:22:11.138465+00
216	dcim	0082_3569_port_fields	2025-11-18 18:22:11.138625+00
217	dcim	0083_3569_cable_fields	2025-11-18 18:22:11.138796+00
218	dcim	0084_3569_powerfeed_fields	2025-11-18 18:22:11.138964+00
219	dcim	0085_3569_poweroutlet_fields	2025-11-18 18:22:11.139133+00
220	dcim	0086_device_name_nonunique	2025-11-18 18:22:11.139304+00
221	dcim	0087_role_descriptions	2025-11-18 18:22:11.139484+00
222	dcim	0088_powerfeed_available_power	2025-11-18 18:22:11.139654+00
223	dcim	0089_deterministic_ordering	2025-11-18 18:22:11.139824+00
224	dcim	0090_cable_termination_models	2025-11-18 18:22:11.139991+00
225	dcim	0091_interface_type_other	2025-11-18 18:22:11.140155+00
226	dcim	0092_fix_rack_outer_unit	2025-11-18 18:22:11.140329+00
227	dcim	0093_device_component_ordering	2025-11-18 18:22:11.140502+00
228	dcim	0094_device_component_template_ordering	2025-11-18 18:22:11.140667+00
229	dcim	0095_primary_model_ordering	2025-11-18 18:22:11.140833+00
230	dcim	0096_interface_ordering	2025-11-18 18:22:11.140993+00
231	dcim	0097_interfacetemplate_type_other	2025-11-18 18:22:11.141155+00
232	dcim	0098_devicetype_images	2025-11-18 18:22:11.141327+00
233	dcim	0099_powerfeed_negative_voltage	2025-11-18 18:22:11.141494+00
234	dcim	0100_mptt_remove_indexes	2025-11-18 18:22:11.141653+00
235	dcim	0101_nested_rackgroups	2025-11-18 18:22:11.141818+00
236	dcim	0102_nested_rackgroups_rebuild	2025-11-18 18:22:11.141978+00
237	dcim	0103_standardize_description	2025-11-18 18:22:11.14214+00
238	dcim	0104_correct_infiniband_types	2025-11-18 18:22:11.142306+00
239	dcim	0105_interface_name_collation	2025-11-18 18:22:11.142483+00
240	dcim	0106_role_default_color	2025-11-18 18:22:11.142652+00
241	dcim	0107_component_labels	2025-11-18 18:22:11.142829+00
242	dcim	0108_add_tags	2025-11-18 18:22:11.142996+00
243	dcim	0109_interface_remove_vm	2025-11-18 18:22:11.143159+00
244	dcim	0110_virtualchassis_name	2025-11-18 18:22:11.143335+00
245	dcim	0111_component_template_description	2025-11-18 18:22:11.143513+00
246	dcim	0112_standardize_components	2025-11-18 18:22:11.143681+00
247	dcim	0113_nullbooleanfield_to_booleanfield	2025-11-18 18:22:11.143841+00
248	dcim	0114_update_jsonfield	2025-11-18 18:22:11.144003+00
249	dcim	0115_rackreservation_order	2025-11-18 18:22:11.144168+00
250	dcim	0116_rearport_max_positions	2025-11-18 18:22:11.144364+00
251	dcim	0117_custom_field_data	2025-11-18 18:22:11.144529+00
252	dcim	0118_inventoryitem_mptt	2025-11-18 18:22:11.144689+00
253	dcim	0119_inventoryitem_mptt_rebuild	2025-11-18 18:22:11.144859+00
254	dcim	0120_cache_cable_peer	2025-11-18 18:22:11.145018+00
255	dcim	0121_cablepath	2025-11-18 18:22:11.145322+00
256	dcim	0122_standardize_name_length	2025-11-18 18:22:11.145486+00
257	dcim	0123_standardize_models	2025-11-18 18:22:11.145648+00
258	dcim	0124_mark_connected	2025-11-18 18:22:11.145809+00
259	dcim	0125_console_port_speed	2025-11-18 18:22:11.145971+00
260	dcim	0126_rename_rackgroup_location	2025-11-18 18:22:11.146131+00
261	dcim	0127_device_location	2025-11-18 18:22:11.146292+00
262	dcim	0128_device_location_populate	2025-11-18 18:22:11.146466+00
263	dcim	0129_interface_parent	2025-11-18 18:22:11.146628+00
264	dcim	0130_sitegroup	2025-11-18 18:22:11.146806+00
265	ipam	0002_vrf_add_enforce_unique	2025-11-18 18:22:11.695155+00
266	ipam	0003_ipam_add_vlangroups	2025-11-18 18:22:11.69556+00
267	ipam	0004_ipam_vlangroup_uniqueness	2025-11-18 18:22:11.69578+00
268	ipam	0005_auto_20160725_1842	2025-11-18 18:22:11.696111+00
269	ipam	0006_vrf_vlan_add_tenant	2025-11-18 18:22:11.696326+00
270	ipam	0007_prefix_ipaddress_add_tenant	2025-11-18 18:22:11.696538+00
271	ipam	0008_prefix_change_order	2025-11-18 18:22:11.696773+00
272	ipam	0009_ipaddress_add_status	2025-11-18 18:22:11.69701+00
273	ipam	0010_ipaddress_help_texts	2025-11-18 18:22:11.697271+00
274	ipam	0011_rir_add_is_private	2025-11-18 18:22:11.697549+00
275	ipam	0012_services	2025-11-18 18:22:11.697795+00
276	ipam	0013_prefix_add_is_pool	2025-11-18 18:22:11.698024+00
277	ipam	0014_ipaddress_status_add_deprecated	2025-11-18 18:22:11.698244+00
278	ipam	0015_global_vlans	2025-11-18 18:22:11.698638+00
279	ipam	0016_unicode_literals	2025-11-18 18:22:11.698859+00
280	ipam	0017_ipaddress_roles	2025-11-18 18:22:11.699081+00
281	ipam	0018_remove_service_uniqueness_constraint	2025-11-18 18:22:11.699292+00
282	ipam	0019_virtualization	2025-11-18 18:22:11.699533+00
283	ipam	0020_ipaddress_add_role_carp	2025-11-18 18:22:11.699764+00
284	ipam	0021_vrf_ordering	2025-11-18 18:22:11.699995+00
285	ipam	0022_tags	2025-11-18 18:22:11.700216+00
286	ipam	0023_change_logging	2025-11-18 18:22:11.700422+00
287	ipam	0024_vrf_allow_null_rd	2025-11-18 18:22:11.700636+00
288	ipam	0025_custom_tag_models	2025-11-18 18:22:11.700854+00
289	ipam	0026_prefix_ordering_vrf_nulls_first	2025-11-18 18:22:11.701072+00
290	ipam	0027_ipaddress_add_dns_name	2025-11-18 18:22:11.701281+00
291	ipam	0028_3569_prefix_fields	2025-11-18 18:22:11.701515+00
292	ipam	0029_3569_ipaddress_fields	2025-11-18 18:22:11.701734+00
293	ipam	0030_3569_vlan_fields	2025-11-18 18:22:11.701958+00
294	ipam	0031_3569_service_fields	2025-11-18 18:22:11.702175+00
295	ipam	0032_role_description	2025-11-18 18:22:11.702373+00
296	ipam	0033_deterministic_ordering	2025-11-18 18:22:11.702565+00
297	ipam	0034_fix_ipaddress_status_dhcp	2025-11-18 18:22:11.702759+00
298	ipam	0035_drop_ip_family	2025-11-18 18:22:11.702954+00
299	ipam	0036_standardize_description	2025-11-18 18:22:11.703157+00
300	ipam	0037_ipaddress_assignment	2025-11-18 18:22:11.703349+00
301	ipam	0038_custom_field_data	2025-11-18 18:22:11.703551+00
302	ipam	0039_service_ports_array	2025-11-18 18:22:11.703762+00
303	ipam	0040_service_drop_port	2025-11-18 18:22:11.703974+00
304	ipam	0041_routetarget	2025-11-18 18:22:11.70418+00
305	ipam	0042_standardize_name_length	2025-11-18 18:22:11.704384+00
306	ipam	0043_add_tenancy_to_aggregates	2025-11-18 18:22:11.704587+00
307	ipam	0044_standardize_models	2025-11-18 18:22:11.704794+00
308	ipam	0045_vlangroup_scope	2025-11-18 18:22:11.704993+00
309	ipam	0046_set_vlangroup_scope_types	2025-11-18 18:22:11.705206+00
310	wireless	0001_wireless	2025-11-18 18:22:12.026044+00
311	wireless	0002_standardize_id_fields	2025-11-18 18:22:12.026448+00
312	wireless	0003_created_datetimefield	2025-11-18 18:22:12.026698+00
313	wireless	0004_wireless_tenancy	2025-11-18 18:22:12.026899+00
314	wireless	0005_wirelesslink_interface_types	2025-11-18 18:22:12.027084+00
315	wireless	0006_unique_constraints	2025-11-18 18:22:12.027279+00
316	wireless	0007_standardize_description_comments	2025-11-18 18:22:12.027484+00
317	wireless	0008_wirelesslan_status	2025-11-18 18:22:12.027689+00
318	ipam	0047_prefix_depth_children	2025-11-18 18:22:12.434578+00
319	ipam	0048_prefix_populate_depth_children	2025-11-18 18:22:12.434992+00
320	ipam	0049_prefix_mark_utilized	2025-11-18 18:22:12.435256+00
321	ipam	0050_iprange	2025-11-18 18:22:12.435473+00
322	ipam	0051_extend_tag_support	2025-11-18 18:22:12.435673+00
323	ipam	0052_fhrpgroup	2025-11-18 18:22:12.43586+00
324	ipam	0053_asn_model	2025-11-18 18:22:12.436043+00
325	dcim	0131_consoleport_speed	2025-11-18 18:22:19.138443+00
326	dcim	0132_cable_length	2025-11-18 18:22:19.139515+00
327	dcim	0133_port_colors	2025-11-18 18:22:19.13984+00
328	dcim	0134_interface_wwn_bridge	2025-11-18 18:22:19.140129+00
329	dcim	0135_tenancy_extensions	2025-11-18 18:22:19.140422+00
330	dcim	0136_device_airflow	2025-11-18 18:22:19.140665+00
331	dcim	0137_relax_uniqueness_constraints	2025-11-18 18:22:19.140903+00
332	dcim	0138_extend_tag_support	2025-11-18 18:22:19.141124+00
333	dcim	0139_rename_cable_peer	2025-11-18 18:22:19.141342+00
334	dcim	0140_wireless	2025-11-18 18:22:19.141554+00
335	dcim	0141_asn_model	2025-11-18 18:22:19.141784+00
336	dcim	0142_rename_128gfc_qsfp28	2025-11-18 18:22:19.142007+00
337	dcim	0143_remove_primary_for_related_name	2025-11-18 18:22:19.142217+00
338	dcim	0144_fix_cable_abs_length	2025-11-18 18:22:19.142441+00
339	dcim	0145_site_remove_deprecated_fields	2025-11-18 18:22:19.142652+00
340	dcim	0146_modules	2025-11-18 18:22:19.142896+00
341	dcim	0147_inventoryitemrole	2025-11-18 18:22:19.143139+00
342	dcim	0148_inventoryitem_component	2025-11-18 18:22:19.14336+00
343	dcim	0149_inventoryitem_templates	2025-11-18 18:22:19.143572+00
344	dcim	0150_interface_vrf	2025-11-18 18:22:19.143777+00
345	dcim	0151_interface_speed_duplex	2025-11-18 18:22:19.143986+00
346	dcim	0152_standardize_id_fields	2025-11-18 18:22:19.144191+00
347	dcim	0153_created_datetimefield	2025-11-18 18:22:19.144393+00
348	dcim	0154_half_height_rack_units	2025-11-18 18:22:19.144593+00
349	dcim	0155_interface_poe_mode_type	2025-11-18 18:22:19.144775+00
350	dcim	0156_location_status	2025-11-18 18:22:19.144949+00
351	dcim	0157_new_cabling_models	2025-11-18 18:22:19.145108+00
352	dcim	0158_populate_cable_terminations	2025-11-18 18:22:19.145268+00
353	dcim	0159_populate_cable_paths	2025-11-18 18:22:19.145432+00
354	circuits	0001_initial	2025-11-18 18:22:19.168988+00
355	circuits	0002_auto_20160622_1821	2025-11-18 18:22:19.819402+00
356	circuits	0003_provider_32bit_asn_support	2025-11-18 18:22:19.819845+00
357	circuits	0004_circuit_add_tenant	2025-11-18 18:22:19.820084+00
358	circuits	0005_circuit_add_upstream_speed	2025-11-18 18:22:19.820279+00
359	circuits	0006_terminations	2025-11-18 18:22:19.820485+00
360	circuits	0007_circuit_add_description	2025-11-18 18:22:19.820867+00
361	circuits	0008_circuittermination_interface_protect_on_delete	2025-11-18 18:22:19.821069+00
362	circuits	0009_unicode_literals	2025-11-18 18:22:19.821242+00
363	circuits	0010_circuit_status	2025-11-18 18:22:19.821486+00
364	circuits	0011_tags	2025-11-18 18:22:19.821746+00
365	circuits	0012_change_logging	2025-11-18 18:22:19.821945+00
366	circuits	0013_cables	2025-11-18 18:22:19.822128+00
367	circuits	0014_circuittermination_description	2025-11-18 18:22:19.822308+00
368	circuits	0015_custom_tag_models	2025-11-18 18:22:19.822485+00
369	circuits	0016_3569_circuit_fields	2025-11-18 18:22:19.822651+00
370	circuits	0017_circuittype_description	2025-11-18 18:22:19.822887+00
371	circuits	0018_standardize_description	2025-11-18 18:22:19.823135+00
372	circuits	0019_nullbooleanfield_to_booleanfield	2025-11-18 18:22:19.823346+00
373	circuits	0020_custom_field_data	2025-11-18 18:22:19.823562+00
374	circuits	0021_cache_cable_peer	2025-11-18 18:22:19.823762+00
375	circuits	0022_cablepath	2025-11-18 18:22:19.823969+00
376	circuits	0023_circuittermination_port_speed_optional	2025-11-18 18:22:19.824163+00
377	circuits	0024_standardize_name_length	2025-11-18 18:22:19.824435+00
378	circuits	0025_standardize_models	2025-11-18 18:22:19.824707+00
379	circuits	0026_mark_connected	2025-11-18 18:22:19.824933+00
380	circuits	0027_providernetwork	2025-11-18 18:22:19.825154+00
381	circuits	0028_cache_circuit_terminations	2025-11-18 18:22:19.825358+00
382	circuits	0029_circuit_tracing	2025-11-18 18:22:19.825548+00
383	circuits	0003_extend_tag_support	2025-11-18 18:22:20.523512+00
384	circuits	0004_rename_cable_peer	2025-11-18 18:22:20.52397+00
385	circuits	0032_provider_service_id	2025-11-18 18:22:20.524202+00
386	circuits	0033_standardize_id_fields	2025-11-18 18:22:20.524426+00
387	circuits	0034_created_datetimefield	2025-11-18 18:22:20.524684+00
388	circuits	0035_provider_asns	2025-11-18 18:22:20.525005+00
389	circuits	0036_circuit_termination_date_tags_custom_fields	2025-11-18 18:22:20.525245+00
390	circuits	0037_new_cabling_models	2025-11-18 18:22:20.525467+00
391	dcim	0160_populate_cable_ends	2025-11-18 18:22:25.007923+00
392	dcim	0161_cabling_cleanup	2025-11-18 18:22:25.008364+00
393	dcim	0162_unique_constraints	2025-11-18 18:22:25.008632+00
394	dcim	0163_weight_fields	2025-11-18 18:22:25.008875+00
395	dcim	0164_rack_mounting_depth	2025-11-18 18:22:25.00918+00
396	dcim	0165_standardize_description_comments	2025-11-18 18:22:25.009512+00
397	dcim	0166_virtualdevicecontext	2025-11-18 18:22:25.009795+00
398	core	0001_initial	2025-11-18 18:22:25.22513+00
399	core	0002_managedfile	2025-11-18 18:22:25.225577+00
400	core	0003_job	2025-11-18 18:22:25.225853+00
401	core	0004_replicate_jobresults	2025-11-18 18:22:25.226097+00
402	core	0005_job_created_auto_now	2025-11-18 18:22:25.226289+00
403	circuits	0038_cabling_cleanup	2025-11-18 18:22:25.947044+00
404	circuits	0039_unique_constraints	2025-11-18 18:22:25.94747+00
405	circuits	0040_provider_remove_deprecated_fields	2025-11-18 18:22:25.947707+00
406	circuits	0041_standardize_description_comments	2025-11-18 18:22:25.947932+00
407	circuits	0042_provideraccount	2025-11-18 18:22:25.948147+00
408	extras	0060_customlink_button_class	2025-11-18 18:22:27.745507+00
409	extras	0061_extras_change_logging	2025-11-18 18:22:27.745944+00
410	extras	0062_clear_secrets_changelog	2025-11-18 18:22:27.746204+00
411	extras	0063_webhook_conditions	2025-11-18 18:22:27.746423+00
412	extras	0064_configrevision	2025-11-18 18:22:27.746625+00
413	extras	0065_imageattachment_change_logging	2025-11-18 18:22:27.746819+00
414	extras	0066_customfield_name_validation	2025-11-18 18:22:27.747015+00
415	extras	0067_customfield_min_max_values	2025-11-18 18:22:27.747224+00
416	extras	0068_configcontext_cluster_types	2025-11-18 18:22:27.747476+00
417	extras	0069_custom_object_field	2025-11-18 18:22:27.747754+00
418	extras	0070_customlink_enabled	2025-11-18 18:22:27.747966+00
419	extras	0071_standardize_id_fields	2025-11-18 18:22:27.748164+00
420	extras	0072_created_datetimefield	2025-11-18 18:22:27.748367+00
421	extras	0073_journalentry_tags_custom_fields	2025-11-18 18:22:27.748559+00
422	extras	0074_customfield_extensions	2025-11-18 18:22:27.74875+00
423	extras	0075_configcontext_locations	2025-11-18 18:22:27.748938+00
424	extras	0076_tag_slug_unicode	2025-11-18 18:22:27.749128+00
425	extras	0077_customlink_extend_text_and_url	2025-11-18 18:22:27.749326+00
426	extras	0078_unique_constraints	2025-11-18 18:22:27.749527+00
427	extras	0079_scheduled_jobs	2025-11-18 18:22:27.749723+00
428	extras	0080_customlink_content_types	2025-11-18 18:22:27.749985+00
429	extras	0081_exporttemplate_content_types	2025-11-18 18:22:27.750231+00
430	extras	0082_savedfilter	2025-11-18 18:22:27.750491+00
431	extras	0083_search	2025-11-18 18:22:27.750727+00
432	extras	0084_staging	2025-11-18 18:22:27.750936+00
433	extras	0085_synced_data	2025-11-18 18:22:27.751145+00
434	extras	0086_configtemplate	2025-11-18 18:22:27.751354+00
435	extras	0087_dashboard	2025-11-18 18:22:28.219794+00
436	extras	0088_jobresult_webhooks	2025-11-18 18:22:28.220224+00
437	extras	0089_customfield_is_cloneable	2025-11-18 18:22:28.220511+00
438	extras	0090_objectchange_index_request_id	2025-11-18 18:22:28.220811+00
439	extras	0091_create_managedfiles	2025-11-18 18:22:28.221034+00
440	extras	0092_delete_jobresult	2025-11-18 18:22:28.221239+00
441	extras	0093_configrevision_ordering	2025-11-18 18:22:28.22146+00
442	extras	0094_tag_object_types	2025-11-18 18:22:28.221649+00
443	extras	0095_bookmarks	2025-11-18 18:22:28.221824+00
444	extras	0096_customfieldchoiceset	2025-11-18 18:22:28.222001+00
445	extras	0097_customfield_remove_choices	2025-11-18 18:22:28.222336+00
446	extras	0098_webhook_custom_field_data_webhook_tags	2025-11-18 18:22:28.222572+00
447	extras	0099_cachedvalue_ordering	2025-11-18 18:22:28.233382+00
448	extras	0100_customfield_ui_attrs	2025-11-18 18:22:28.297706+00
449	extras	0101_eventrule	2025-11-18 18:22:28.915203+00
450	extras	0102_move_configrevision	2025-11-18 18:22:29.09576+00
451	extras	0103_gfk_indexes	2025-11-18 18:22:29.202751+00
452	extras	0104_stagedchange_remove_change_logging	2025-11-18 18:22:29.226201+00
453	extras	0105_customfield_min_max_values	2025-11-18 18:22:29.256704+00
454	extras	0106_bookmark_user_cascade_deletion	2025-11-18 18:22:29.295597+00
455	extras	0107_cachedvalue_extras_cachedvalue_object	2025-11-18 18:22:29.307428+00
456	extras	0108_convert_reports_to_scripts	2025-11-18 18:22:29.34543+00
457	extras	0109_script_model	2025-11-18 18:22:29.464546+00
458	extras	0110_remove_eventrule_action_parameters	2025-11-18 18:22:29.500891+00
459	core	0006_datasource_type_remove_choices	2025-11-18 18:22:29.530926+00
460	core	0007_job_add_error_field	2025-11-18 18:22:29.552245+00
461	core	0008_contenttype_proxy	2025-11-18 18:22:29.554039+00
462	core	0009_configrevision	2025-11-18 18:22:29.556752+00
463	core	0010_gfk_indexes	2025-11-18 18:22:29.571264+00
464	extras	0111_rename_content_types	2025-11-18 18:22:30.070581+00
465	extras	0112_tag_update_object_types	2025-11-18 18:22:30.110969+00
466	extras	0113_customfield_rename_object_type	2025-11-18 18:22:30.125281+00
467	users	0005_alter_user_table	2025-11-18 18:22:30.329157+00
468	users	0006_custom_group_model	2025-11-18 18:22:30.503693+00
469	users	0007_objectpermission_update_object_types	2025-11-18 18:22:30.543375+00
470	users	0008_flip_objectpermission_assignments	2025-11-18 18:22:30.695881+00
471	users	0009_update_group_perms	2025-11-18 18:22:30.920135+00
472	extras	0114_customfield_add_comments	2025-11-18 18:22:30.931939+00
473	extras	0115_convert_dashboard_widgets	2025-11-18 18:22:30.968398+00
474	extras	0116_custom_link_button_color	2025-11-18 18:22:31.020333+00
475	core	0011_move_objectchange	2025-11-18 18:22:31.058158+00
476	extras	0117_move_objectchange	2025-11-18 18:22:31.152695+00
477	extras	0118_customfield_uniqueness	2025-11-18 18:22:31.164126+00
478	extras	0119_notifications	2025-11-18 18:22:31.338351+00
479	extras	0120_eventrule_event_types	2025-11-18 18:22:31.748245+00
480	extras	0121_customfield_related_object_filter	2025-11-18 18:22:31.763961+00
481	extras	0122_charfield_null_choices	2025-11-18 18:22:31.815593+00
482	tenancy	0012_contactassignment_custom_fields	2025-11-18 18:22:31.858287+00
483	tenancy	0013_gfk_indexes	2025-11-18 18:22:31.895719+00
484	tenancy	0014_contactassignment_ordering	2025-11-18 18:22:32.093805+00
485	tenancy	0015_contactassignment_rename_content_type	2025-11-18 18:22:32.289442+00
486	tenancy	0016_charfield_null_choices	2025-11-18 18:22:32.369358+00
487	ipam	0054_vlangroup_min_max_vids	2025-11-18 18:22:35.348892+00
488	ipam	0055_servicetemplate	2025-11-18 18:22:35.34982+00
489	ipam	0056_standardize_id_fields	2025-11-18 18:22:35.350085+00
490	ipam	0057_created_datetimefield	2025-11-18 18:22:35.350286+00
491	ipam	0058_ipaddress_nat_inside_nonunique	2025-11-18 18:22:35.350488+00
492	ipam	0059_l2vpn	2025-11-18 18:22:35.350733+00
493	ipam	0060_alter_l2vpn_slug	2025-11-18 18:22:35.350935+00
494	ipam	0061_fhrpgroup_name	2025-11-18 18:22:35.351176+00
495	ipam	0062_unique_constraints	2025-11-18 18:22:35.351444+00
496	ipam	0063_standardize_description_comments	2025-11-18 18:22:35.35166+00
497	ipam	0064_clear_search_cache	2025-11-18 18:22:35.351862+00
498	ipam	0065_asnrange	2025-11-18 18:22:35.352059+00
499	ipam	0066_iprange_mark_utilized	2025-11-18 18:22:35.352256+00
500	ipam	0067_ipaddress_index_host	2025-11-18 18:22:35.352474+00
501	ipam	0068_move_l2vpn	2025-11-18 18:22:35.636184+00
502	ipam	0069_gfk_indexes	2025-11-18 18:22:35.726614+00
503	ipam	0070_vlangroup_vlan_id_ranges	2025-11-18 18:22:36.114326+00
504	ipam	0071_prefix_scope	2025-11-18 18:22:36.240518+00
505	dcim	0167_module_status	2025-11-18 18:22:38.233441+00
506	dcim	0168_interface_template_enabled	2025-11-18 18:22:38.233916+00
507	dcim	0169_devicetype_default_platform	2025-11-18 18:22:38.234162+00
508	dcim	0170_configtemplate	2025-11-18 18:22:38.234387+00
509	dcim	0171_cabletermination_change_logging	2025-11-18 18:22:38.234595+00
510	dcim	0172_larger_power_draw_values	2025-11-18 18:22:38.23485+00
511	dcim	0173_remove_napalm_fields	2025-11-18 18:22:38.235169+00
512	dcim	0174_device_latitude_device_longitude	2025-11-18 18:22:38.235448+00
513	dcim	0174_rack_starting_unit	2025-11-18 18:22:38.235735+00
514	dcim	0175_device_oob_ip	2025-11-18 18:22:38.236014+00
515	dcim	0176_device_component_counters	2025-11-18 18:22:38.236261+00
516	dcim	0177_devicetype_component_counters	2025-11-18 18:22:38.236514+00
517	dcim	0178_virtual_chassis_member_counter	2025-11-18 18:22:38.236745+00
518	dcim	0179_interfacetemplate_rf_role	2025-11-18 18:22:38.237012+00
519	dcim	0180_powerfeed_tenant	2025-11-18 18:22:38.237251+00
520	dcim	0181_rename_device_role_device_role	2025-11-18 18:22:38.237484+00
521	dcim	0182_zero_length_cable_fix	2025-11-18 18:22:38.237721+00
522	dcim	0183_devicetype_exclude_from_utilization	2025-11-18 18:22:38.273455+00
523	dcim	0184_protect_child_interfaces	2025-11-18 18:22:38.320806+00
524	dcim	0185_gfk_indexes	2025-11-18 18:22:38.571+00
525	dcim	0186_location_facility	2025-11-18 18:22:38.602849+00
526	dcim	0187_alter_device_vc_position	2025-11-18 18:22:38.649744+00
527	dcim	0188_racktype	2025-11-18 18:22:38.830155+00
528	dcim	0189_moduletype_rack_airflow	2025-11-18 18:22:38.894517+00
529	dcim	0190_nested_modules	2025-11-18 18:22:39.460567+00
530	dcim	0191_module_bay_rebuild	2025-11-18 18:22:39.511696+00
531	dcim	0192_inventoryitem_status	2025-11-18 18:22:39.555285+00
532	dcim	0193_poweroutlet_color	2025-11-18 18:22:39.588789+00
533	ipam	0072_prefix_cached_relations	2025-11-18 18:22:40.104529+00
534	ipam	0073_charfield_null_choices	2025-11-18 18:22:40.229904+00
535	ipam	0074_vlantranslationpolicy_vlantranslationrule	2025-11-18 18:22:40.554545+00
536	ipam	0075_vlan_qinq	2025-11-18 18:22:40.70739+00
537	dcim	0194_charfield_null_choices	2025-11-18 18:22:42.383796+00
538	dcim	0195_interface_vlan_translation_policy	2025-11-18 18:22:42.432674+00
539	dcim	0196_qinq_svlan	2025-11-18 18:22:42.568448+00
540	dcim	0197_natural_sort_collation	2025-11-18 18:22:42.575463+00
541	circuits	0043_circuittype_color	2025-11-18 18:22:42.605312+00
542	circuits	0044_circuit_groups	2025-11-18 18:22:42.733673+00
543	circuits	0045_circuit_distance	2025-11-18 18:22:43.017947+00
544	circuits	0046_charfield_null_choices	2025-11-18 18:22:43.144719+00
545	circuits	0047_circuittermination__termination	2025-11-18 18:22:43.259187+00
546	circuits	0048_circuitterminations_cached_relations	2025-11-18 18:22:43.71186+00
547	circuits	0049_natural_ordering	2025-11-18 18:22:43.773282+00
548	circuits	0050_virtual_circuits	2025-11-18 18:22:43.984129+00
549	circuits	0051_virtualcircuit_group_assignment	2025-11-18 18:22:44.462287+00
550	circuits	0052_extend_circuit_abs_distance_upper_limit	2025-11-18 18:22:44.496858+00
551	core	0012_job_object_type_optional	2025-11-18 18:22:44.546088+00
552	core	0013_job_data_encoder	2025-11-18 18:22:44.559917+00
553	core	0014_datasource_sync_interval	2025-11-18 18:22:44.591118+00
554	core	0015_remove_redundant_indexes	2025-11-18 18:22:44.615127+00
555	core	0016_job_log_entries	2025-11-18 18:22:44.629559+00
556	core	0017_objectchange_message	2025-11-18 18:22:44.793397+00
557	core	0018_concrete_objecttype	2025-11-18 18:22:44.839281+00
558	core	0019_configrevision_active	2025-11-18 18:22:44.890897+00
559	extras	0123_journalentry_kind_default	2025-11-18 18:22:44.933478+00
560	extras	0124_remove_staging	2025-11-18 18:22:45.026949+00
561	extras	0125_alter_tag_options_tag_weight	2025-11-18 18:22:45.098554+00
562	extras	0126_exporttemplate_file_name	2025-11-18 18:22:45.11318+00
563	extras	0127_configtemplate_as_attachment_and_more	2025-11-18 18:22:45.405941+00
564	extras	0128_tableconfig	2025-11-18 18:22:45.454099+00
565	extras	0129_fix_script_paths	2025-11-18 18:22:45.495729+00
566	dcim	0198_natural_ordering	2025-11-18 18:22:47.723754+00
567	dcim	0199_macaddress	2025-11-18 18:22:47.771977+00
568	dcim	0200_populate_mac_addresses	2025-11-18 18:22:47.900666+00
569	dcim	0201_add_power_outlet_status	2025-11-18 18:22:47.933861+00
570	dcim	0202_location_comments_region_comments_sitegroup_comments	2025-11-18 18:22:48.02821+00
571	dcim	0203_add_rack_outer_height	2025-11-18 18:22:48.518112+00
572	dcim	0203_device_role_nested	2025-11-18 18:22:48.804893+00
573	dcim	0204_device_role_rebuild	2025-11-18 18:22:48.850006+00
574	dcim	0205_moduletypeprofile	2025-11-18 18:22:49.16131+00
575	dcim	0206_load_module_type_profiles	2025-11-18 18:22:49.221825+00
576	dcim	0207_remove_redundant_indexes	2025-11-18 18:22:49.249294+00
577	dcim	0208_devicerole_uniqueness	2025-11-18 18:22:49.374198+00
578	dcim	0209_device_component_denorm_site_location	2025-11-18 18:22:51.377166+00
579	dcim	0210_macaddress_ordering	2025-11-18 18:22:51.413389+00
580	dcim	0211_platform_manufacturer_uniqueness	2025-11-18 18:22:51.644091+00
581	dcim	0212_interface_tx_power_negative	2025-11-18 18:22:51.678467+00
582	dcim	0213_platform_parent	2025-11-18 18:22:52.048223+00
583	dcim	0214_platform_rebuild	2025-11-18 18:22:52.092113+00
584	dcim	0215_rackreservation_status	2025-11-18 18:22:52.129454+00
585	django_rq	0001_initial	2025-11-18 18:22:52.130831+00
586	extras	0130_imageattachment_description	2025-11-18 18:22:52.141419+00
587	extras	0131_concrete_objecttype	2025-11-18 18:22:52.58134+00
588	extras	0132_configcontextprofile	2025-11-18 18:22:52.683844+00
589	extras	0133_make_cf_minmax_decimal	2025-11-18 18:22:52.717915+00
590	tenancy	0017_natural_ordering	2025-11-18 18:22:52.848006+00
591	tenancy	0018_contact_groups	2025-11-18 18:22:53.264252+00
592	tenancy	0019_contactgroup_comments_tenantgroup_comments	2025-11-18 18:22:53.330703+00
593	tenancy	0020_remove_contactgroupmembership	2025-11-18 18:22:53.430427+00
594	virtualization	0023_virtualmachine_natural_ordering	2025-11-18 18:22:55.358473+00
595	virtualization	0024_cluster_relax_uniqueness	2025-11-18 18:22:55.358986+00
596	virtualization	0025_extend_tag_support	2025-11-18 18:22:55.359229+00
597	virtualization	0026_vminterface_bridge	2025-11-18 18:22:55.359454+00
598	virtualization	0027_standardize_id_fields	2025-11-18 18:22:55.359652+00
599	virtualization	0028_vminterface_vrf	2025-11-18 18:22:55.359855+00
600	virtualization	0029_created_datetimefield	2025-11-18 18:22:55.360056+00
601	virtualization	0030_cluster_status	2025-11-18 18:22:55.360262+00
602	virtualization	0031_virtualmachine_site_device	2025-11-18 18:22:55.360478+00
603	virtualization	0032_virtualmachine_update_sites	2025-11-18 18:22:55.360671+00
604	virtualization	0033_unique_constraints	2025-11-18 18:22:55.36086+00
605	virtualization	0034_standardize_description_comments	2025-11-18 18:22:55.361034+00
606	virtualization	0035_virtualmachine_interface_count	2025-11-18 18:22:55.361213+00
607	virtualization	0036_virtualmachine_config_template	2025-11-18 18:22:55.36147+00
608	virtualization	0037_protect_child_interfaces	2025-11-18 18:22:55.409235+00
609	virtualization	0038_virtualdisk	2025-11-18 18:22:55.540296+00
610	virtualization	0039_virtualmachine_serial_number	2025-11-18 18:22:55.577182+00
611	virtualization	0040_convert_disk_size	2025-11-18 18:22:55.632492+00
612	virtualization	0041_charfield_null_choices	2025-11-18 18:22:55.718228+00
613	virtualization	0042_vminterface_vlan_translation_policy	2025-11-18 18:22:55.775149+00
614	virtualization	0043_qinq_svlan	2025-11-18 18:22:56.086343+00
615	virtualization	0044_cluster_scope	2025-11-18 18:22:56.221256+00
616	virtualization	0045_clusters_cached_relations	2025-11-18 18:22:56.739655+00
617	virtualization	0046_alter_cluster__location_alter_cluster__region_and_more	2025-11-18 18:22:56.933681+00
618	virtualization	0047_natural_ordering	2025-11-18 18:22:57.332194+00
619	virtualization	0048_populate_mac_addresses	2025-11-18 18:22:57.462554+00
620	ipam	0076_natural_ordering	2025-11-18 18:22:57.772241+00
621	ipam	0077_vlangroup_tenant	2025-11-18 18:22:57.825228+00
622	ipam	0078_iprange_mark_utilized	2025-11-18 18:22:57.860837+00
623	ipam	0079_add_service_fhrp_group_parent_gfk	2025-11-18 18:22:57.944823+00
624	ipam	0080_populate_service_parent	2025-11-18 18:22:57.994537+00
625	ipam	0081_remove_service_device_virtual_machine_add_parent_gfk_index	2025-11-18 18:22:58.370019+00
626	ipam	0082_add_prefix_network_containment_indexes	2025-11-18 18:22:58.410546+00
627	ipam	0083_vlangroup_populate_total_vlan_ids	2025-11-18 18:22:58.457143+00
628	netbox_bgp	0001_initial	2025-11-18 18:22:58.613206+00
629	netbox_bgp	0002_netbox_bgp	2025-11-18 18:22:58.718681+00
630	netbox_bgp	0003_netbox_bgp	2025-11-18 18:22:58.935981+00
631	netbox_bgp	0004_netbox_bgp	2025-11-18 18:22:58.988913+00
632	netbox_bgp	0005_netbox_bgp	2025-11-18 18:22:59.02463+00
633	netbox_bgp	0006_netbox_bgp	2025-11-18 18:22:59.0617+00
634	netbox_bgp	0007_netbox_bgp	2025-11-18 18:22:59.105466+00
635	netbox_bgp	0008_netbox_bgp	2025-11-18 18:22:59.253173+00
636	netbox_bgp	0009_netbox_bgp	2025-11-18 18:22:59.302425+00
637	netbox_bgp	0010_netbox_bgp	2025-11-18 18:22:59.850833+00
638	netbox_bgp	0011_netbox_bgp	2025-11-18 18:23:00.275398+00
639	netbox_bgp	0012_netbox_bgp	2025-11-18 18:23:00.314782+00
640	netbox_bgp	0013_netbox_bgp	2025-11-18 18:23:00.354946+00
641	netbox_bgp	0014_netbox_bgp	2025-11-18 18:23:00.374015+00
642	netbox_bgp	0015_netbox_bgp	2025-11-18 18:23:00.483797+00
643	netbox_bgp	0016_netbox_bgp	2025-11-18 18:23:00.555649+00
644	netbox_bgp	0017_netbox_bgp	2025-11-18 18:23:00.866923+00
645	netbox_bgp	0018_netbox_bgp	2025-11-18 18:23:00.964705+00
646	netbox_bgp	0019_netbox_bgp	2025-11-18 18:23:01.001078+00
647	netbox_bgp	0020_netbox_bgp	2025-11-18 18:23:01.049322+00
648	netbox_bgp	0021_netbox32_support	2025-11-18 18:23:02.117022+00
649	netbox_bgp	0022_netbox_bgp	2025-11-18 18:23:02.183032+00
650	netbox_bgp	0023_netbox_bgp	2025-11-18 18:23:02.292309+00
651	netbox_bgp	0024_netbox_bgp	2025-11-18 18:23:02.672059+00
652	netbox_bgp	0025_netbox_bgp	2025-11-18 18:23:02.770412+00
653	netbox_bgp	0026_netbox_bgp	2025-11-18 18:23:03.199205+00
654	netbox_bgp	0027_netbox_bgp	2025-11-18 18:23:03.487708+00
655	netbox_bgp	0028_netbox_bgp	2025-11-18 18:23:03.538067+00
656	netbox_bgp	0029_netbox_bgp	2025-11-18 18:23:03.578772+00
657	netbox_bgp	0030_netbox_bgp_comments	2025-11-18 18:23:04.04192+00
658	netbox_bgp	0031_netbox_bgp	2025-11-18 18:23:04.404661+00
659	netbox_bgp	0032_netbox_bgp	2025-11-18 18:23:04.512749+00
660	netbox_bgp	0033_alter_bgpsession_unique_together_and_more	2025-11-18 18:23:04.639933+00
661	netbox_bgp	0034_aspathlist_routingpolicyrule_match_aspath_list_and_more	2025-11-18 18:23:04.948099+00
662	netbox_bgp	0035_alter_aspathlist_options_and_more	2025-11-18 18:23:05.51262+00
663	sessions	0001_initial	2025-11-18 18:23:05.518967+00
664	default	0001_initial	2025-11-18 18:23:05.598411+00
665	social_auth	0001_initial	2025-11-18 18:23:05.598797+00
666	default	0002_add_related_name	2025-11-18 18:23:05.648086+00
667	social_auth	0002_add_related_name	2025-11-18 18:23:05.648525+00
668	default	0003_alter_email_max_length	2025-11-18 18:23:05.651699+00
669	social_auth	0003_alter_email_max_length	2025-11-18 18:23:05.65184+00
670	default	0004_auto_20160423_0400	2025-11-18 18:23:05.659498+00
671	social_auth	0004_auto_20160423_0400	2025-11-18 18:23:05.659821+00
672	social_auth	0005_auto_20160727_2333	2025-11-18 18:23:05.662817+00
673	social_django	0006_partial	2025-11-18 18:23:05.66724+00
674	social_django	0007_code_timestamp	2025-11-18 18:23:05.670676+00
675	social_django	0008_partial_timestamp	2025-11-18 18:23:05.67446+00
676	social_django	0009_auto_20191118_0520	2025-11-18 18:23:05.689332+00
677	social_django	0010_uid_db_index	2025-11-18 18:23:05.699092+00
678	social_django	0011_alter_id_fields	2025-11-18 18:23:05.738638+00
679	social_django	0012_usersocialauth_extra_data_new	2025-11-18 18:23:05.748954+00
680	social_django	0013_migrate_extra_data	2025-11-18 18:23:05.798406+00
681	social_django	0014_remove_usersocialauth_extra_data	2025-11-18 18:23:05.807891+00
682	social_django	0015_rename_extra_data_new_usersocialauth_extra_data	2025-11-18 18:23:05.818108+00
683	social_django	0016_alter_usersocialauth_extra_data	2025-11-18 18:23:05.825144+00
684	social_django	0017_usersocialauth_user_social_auth_uid_required	2025-11-18 18:23:05.833325+00
685	taggit	0001_initial	2025-11-18 18:23:05.897465+00
686	taggit	0002_auto_20150616_2121	2025-11-18 18:23:05.911775+00
687	taggit	0003_taggeditem_add_unique_index	2025-11-18 18:23:05.92583+00
688	taggit	0004_alter_taggeditem_content_type_alter_taggeditem_tag	2025-11-18 18:23:06.200728+00
689	taggit	0005_auto_20220424_2025	2025-11-18 18:23:06.204087+00
690	taggit	0006_rename_taggeditem_content_type_object_id_taggit_tagg_content_8fc721_idx	2025-11-18 18:23:06.229656+00
691	thumbnail	0001_initial	2025-11-18 18:23:06.2334+00
692	users	0010_add_token_meta_ordering	2025-11-18 18:23:06.240442+00
693	users	0011_concrete_objecttype	2025-11-18 18:23:06.295584+00
694	users	0012_drop_django_admin_log_table	2025-11-18 18:23:06.297755+00
695	vpn	0001_initial	2025-11-18 18:23:07.315924+00
696	vpn	0002_move_l2vpn	2025-11-18 18:23:07.514531+00
697	vpn	0003_ipaddress_multiple_tunnel_terminations	2025-11-18 18:23:07.576998+00
698	vpn	0004_alter_ikepolicy_mode	2025-11-18 18:23:07.620132+00
699	vpn	0005_rename_indexes	2025-11-18 18:23:07.632401+00
700	vpn	0006_charfield_null_choices	2025-11-18 18:23:08.066671+00
701	vpn	0007_natural_ordering	2025-11-18 18:23:08.55724+00
702	vpn	0008_add_l2vpn_status	2025-11-18 18:23:08.600666+00
703	vpn	0009_remove_redundant_indexes	2025-11-18 18:23:08.698088+00
704	wireless	0009_wirelesslink_distance	2025-11-18 18:23:08.825145+00
705	wireless	0010_charfield_null_choices	2025-11-18 18:23:09.269453+00
706	wireless	0011_wirelesslan__location_wirelesslan__region_and_more	2025-11-18 18:23:09.765298+00
707	wireless	0012_alter_wirelesslan__location_and_more	2025-11-18 18:23:10.003082+00
708	wireless	0013_natural_ordering	2025-11-18 18:23:10.055249+00
709	wireless	0014_wirelesslangroup_comments	2025-11-18 18:23:10.247395+00
710	wireless	0015_extend_wireless_link_abs_distance_upper_limit	2025-11-18 18:23:10.290881+00
711	social_django	0003_alter_email_max_length	2025-11-18 18:23:10.29434+00
712	social_django	0005_auto_20160727_2333	2025-11-18 18:23:10.294669+00
713	social_django	0004_auto_20160423_0400	2025-11-18 18:23:10.294909+00
714	social_django	0001_initial	2025-11-18 18:23:10.295136+00
715	social_django	0002_add_related_name	2025-11-18 18:23:10.295405+00
716	core	0001_squashed_0005	2025-11-18 18:23:10.295651+00
717	circuits	0038_squashed_0042	2025-11-18 18:23:10.295848+00
718	circuits	0001_squashed	2025-11-18 18:23:10.296045+00
719	circuits	0003_squashed_0037	2025-11-18 18:23:10.296257+00
720	circuits	0002_squashed_0029	2025-11-18 18:23:10.296471+00
721	dcim	0160_squashed_0166	2025-11-18 18:23:10.296652+00
722	dcim	0001_squashed	2025-11-18 18:23:10.296833+00
723	dcim	0003_squashed_0130	2025-11-18 18:23:10.297036+00
724	dcim	0002_squashed	2025-11-18 18:23:10.297238+00
725	dcim	0131_squashed_0159	2025-11-18 18:23:10.297449+00
726	dcim	0167_squashed_0182	2025-11-18 18:23:10.297921+00
727	ipam	0001_squashed	2025-11-18 18:23:10.298175+00
728	ipam	0047_squashed_0053	2025-11-18 18:23:10.29838+00
729	ipam	0002_squashed_0046	2025-11-18 18:23:10.298572+00
730	ipam	0054_squashed_0067	2025-11-18 18:23:10.298761+00
731	extras	0001_squashed	2025-11-18 18:23:10.298936+00
732	extras	0087_squashed_0098	2025-11-18 18:23:10.29911+00
733	extras	0002_squashed_0059	2025-11-18 18:23:10.299336+00
734	extras	0060_squashed_0086	2025-11-18 18:23:10.299547+00
735	tenancy	0001_squashed_0012	2025-11-18 18:23:10.299737+00
736	tenancy	0002_squashed_0011	2025-11-18 18:23:10.299947+00
737	users	0001_squashed_0011	2025-11-18 18:23:10.300167+00
738	users	0002_squashed_0004	2025-11-18 18:23:10.300378+00
739	virtualization	0001_squashed_0022	2025-11-18 18:23:10.300567+00
740	virtualization	0023_squashed_0036	2025-11-18 18:23:10.300772+00
741	wireless	0001_squashed_0008	2025-11-18 18:23:10.300968+00
\.
...
d2275285-9a23-4a84-a001-5cbd63273add	2025-11-18 18:22:49.209885+00	1	name	str	CPU	100	10
39169f4c-f944-409b-84c0-e22e85972959	2025-11-18 18:22:49.212084+00	2	name	str	Fan	100	10
abcd104d-3362-400b-aef9-9f1dd34e38cc	2025-11-18 18:22:49.214072+00	3	name	str	GPU	100	10
0798c886-0ef6-420b-9394-a3f837811e87	2025-11-18 18:22:49.215956+00	4	name	str	Hard disk	100	10
bac7d464-7e01-4fdc-8c1f-8a7cd17efbf9	2025-11-18 18:22:49.217871+00	5	name	str	Memory	100	10
25335ec5-2425-4fd2-9bff-0ae4fe69d617	2025-11-18 18:22:49.21973+00	6	name	str	Power supply	100	10
f693807e-c255-4a0b-bf8a-08cb821aec59	2025-11-18 18:22:49.221604+00	7	name	str	Expansion card	100	10
\.
...
--
-- Data for Name: netbox_bgp_aspathlist; Type: TABLE DATA; Schema: public; Owner: netbox
--

COPY public.netbox_bgp_aspathlist (id, created, last_updated, custom_field_data, name, description, comments) FROM stdin;
\.


--
-- Data for Name: netbox_bgp_aspathlistrule; Type: TABLE DATA; Schema: public; Owner: netbox
--

COPY public.netbox_bgp_aspathlistrule (id, created, last_updated, custom_field_data, index, action, pattern, description, comments, aspath_list_id) FROM stdin;
\.
...
COPY public.netbox_bgp_bgpsession (id, created, last_updated, status, description, local_address_id, local_as_id, remote_address_id, remote_as_id, site_id, tenant_id, device_id, name, peer_group_id, custom_field_data, comments, prefix_list_in_id, prefix_list_out_id, virtualmachine_id) FROM stdin;
\.
...
--
-- Data for Name: netbox_bgp_routingpolicyrule_match_aspath_list; Type: TABLE DATA; Schema: public; Owner: netbox
--

COPY public.netbox_bgp_routingpolicyrule_match_aspath_list (id, routingpolicyrule_id, aspathlist_id) FROM stdin;
\.
...
1	2025-11-18 18:23:22.544+00	\N	0123456789abcdef0123456789abcdef01234567	t		1	\N	\N
\.
...
1	pbkdf2_sha256$1000000$mxQ6w5B5grcOIEXnYe2wjb$PU/dwZFb/ToOJRkNbbVDkshgo044LESZFyKf/4JeYWM=	\N	t	admin			admin@example.com	t	t	2025-11-18 18:23:22.395561+00
\.
...
SELECT pg_catalog.setval('public.auth_permission_id_seq', 637, true);
...
SELECT pg_catalog.setval('public.django_migrations_id_seq', 741, true);
...
--
-- Name: netbox_bgp_aspathlist_id_seq; Type: SEQUENCE SET; Schema: public; Owner: netbox
--

SELECT pg_catalog.setval('public.netbox_bgp_aspathlist_id_seq', 1, false);


--
-- Name: netbox_bgp_aspathlistrule_id_seq; Type: SEQUENCE SET; Schema: public; Owner: netbox
--

SELECT pg_catalog.setval('public.netbox_bgp_aspathlistrule_id_seq', 1, false);
...
--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list_id_seq; Type: SEQUENCE SET; Schema: public; Owner: netbox
--

SELECT pg_catalog.setval('public.netbox_bgp_routingpolicyrule_match_aspath_list_id_seq', 1, false);
...
--
-- Name: netbox_bgp_aspathlist netbox_bgp_aspathlist_name_description_9d64c44e_uniq; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_aspathlist
    ADD CONSTRAINT netbox_bgp_aspathlist_name_description_9d64c44e_uniq UNIQUE (name, description);


--
-- Name: netbox_bgp_aspathlist netbox_bgp_aspathlist_pkey; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_aspathlist
    ADD CONSTRAINT netbox_bgp_aspathlist_pkey PRIMARY KEY (id);


--
-- Name: netbox_bgp_aspathlistrule netbox_bgp_aspathlistrule_pkey; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_aspathlistrule
    ADD CONSTRAINT netbox_bgp_aspathlistrule_pkey PRIMARY KEY (id);
...
--
-- Name: netbox_bgp_bgpsession netbox_bgp_bgpsession_virtualmachine_id_local__aeec6e47_uniq; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_bgpsession
    ADD CONSTRAINT netbox_bgp_bgpsession_virtualmachine_id_local__aeec6e47_uniq UNIQUE (virtualmachine_id, local_address_id, local_as_id, remote_address_id, remote_as_id);
...
--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list netbox_bgp_routingpolicy_routingpolicyrule_id_asp_4d8f583a_uniq; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_routingpolicyrule_match_aspath_list
    ADD CONSTRAINT netbox_bgp_routingpolicy_routingpolicyrule_id_asp_4d8f583a_uniq UNIQUE (routingpolicyrule_id, aspathlist_id);
...
--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list netbox_bgp_routingpolicyrule_match_aspath_list_pkey; Type: CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_routingpolicyrule_match_aspath_list
    ADD CONSTRAINT netbox_bgp_routingpolicyrule_match_aspath_list_pkey PRIMARY KEY (id);
...
--
-- Name: netbox_bgp_aspathlistrule_aspath_list_id_9c863e60; Type: INDEX; Schema: public; Owner: netbox
--

CREATE INDEX netbox_bgp_aspathlistrule_aspath_list_id_9c863e60 ON public.netbox_bgp_aspathlistrule USING btree (aspath_list_id);
...
--
-- Name: netbox_bgp_bgpsession_virtualmachine_id_2d5767ac; Type: INDEX; Schema: public; Owner: netbox
--

CREATE INDEX netbox_bgp_bgpsession_virtualmachine_id_2d5767ac ON public.netbox_bgp_bgpsession USING btree (virtualmachine_id);
...
--
-- Name: netbox_bgp_routingpolicyru_aspathlist_id_e8be4cd6; Type: INDEX; Schema: public; Owner: netbox
--

CREATE INDEX netbox_bgp_routingpolicyru_aspathlist_id_e8be4cd6 ON public.netbox_bgp_routingpolicyrule_match_aspath_list USING btree (aspathlist_id);
...
--
-- Name: netbox_bgp_routingpolicyru_routingpolicyrule_id_05e70219; Type: INDEX; Schema: public; Owner: netbox
--

CREATE INDEX netbox_bgp_routingpolicyru_routingpolicyrule_id_05e70219 ON public.netbox_bgp_routingpolicyrule_match_aspath_list USING btree (routingpolicyrule_id);
...
--
-- Name: netbox_bgp_aspathlistrule netbox_bgp_aspathlis_aspath_list_id_9c863e60_fk_netbox_bg; Type: FK CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_aspathlistrule
    ADD CONSTRAINT netbox_bgp_aspathlis_aspath_list_id_9c863e60_fk_netbox_bg FOREIGN KEY (aspath_list_id) REFERENCES public.netbox_bgp_aspathlist(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: netbox_bgp_bgpsession netbox_bgp_bgpsessio_virtualmachine_id_2d5767ac_fk_virtualiz; Type: FK CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_bgpsession
    ADD CONSTRAINT netbox_bgp_bgpsessio_virtualmachine_id_2d5767ac_fk_virtualiz FOREIGN KEY (virtualmachine_id) REFERENCES public.virtualization_virtualmachine(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list netbox_bgp_routingpo_aspathlist_id_e8be4cd6_fk_netbox_bg; Type: FK CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_routingpolicyrule_match_aspath_list
    ADD CONSTRAINT netbox_bgp_routingpo_aspathlist_id_e8be4cd6_fk_netbox_bg FOREIGN KEY (aspathlist_id) REFERENCES public.netbox_bgp_aspathlist(id) DEFERRABLE INITIALLY DEFERRED;
...
--
-- Name: netbox_bgp_routingpolicyrule_match_aspath_list netbox_bgp_routingpo_routingpolicyrule_id_05e70219_fk_netbox_bg; Type: FK CONSTRAINT; Schema: public; Owner: netbox
--

ALTER TABLE ONLY public.netbox_bgp_routingpolicyrule_match_aspath_list
    ADD CONSTRAINT netbox_bgp_routingpo_routingpolicyrule_id_05e70219_fk_netbox_bg FOREIGN KEY (routingpolicyrule_id) REFERENCES public.netbox_bgp_routingpolicyrule(id) DEFERRABLE INITIALLY DEFERRED;
